-- Ultra-Safe Production Database Migration
-- This migration checks for table AND column existence before creating foreign keys
...
-- =====================================================
-- STEP 3: Create parent_communications table with all columns
-- =====================================================
...
-- =====================================================
-- STEP 4: Create other parent feature tables
-- =====================================================
...
-- Add foreign key constraints only after ensuring all tables and columns exist
DO $$ 
BEGIN
  ...
  -- Add foreign key constraints to lunch_accounts
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Add foreign key constraints to lunch_transactions
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Add foreign key constraints to academic_records
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
  ...
  -- Add foreign key constraints to attendance_records
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
