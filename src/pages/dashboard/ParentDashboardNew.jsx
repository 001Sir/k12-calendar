...
export default function ParentDashboardNew() {
  ...
  // Filter events that the parent has RSVP'd to
  const myEvents = events.filter(event => 
    rsvps.some(rsvp => rsvp.event_id === event.id)
  )
  ...
  const metrics = {
    ...
    totalSpent: myEvents.reduce((sum, event) => sum + (event.price || 0), 0)
  }
  ...
  const chartData = {
    ...
    spending: Array.from({ length: 12 }, (_, i) => ({
      date: i + 1,
  ...
  const upcomingEvents = myEvents.slice(0, 2).map(event => ({
    ...
    price: event.price || 0,
    rsvpStatus: rsvps.find(r => r.event_id === event.id)?.status || 'pending',
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                />
                <div>
                  <p className="text-sm font-medium text-gray-900">{profile?.full_name || 'Parent'}</p>
          ...
          <div className="col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-xl p-5 shadow-sm">
                ...
                <div className="flex items-baseline gap-2">
                  <p className="text-3xl font-bold">{metrics.confirmedRSVPs}</p>
                  <span className="text-xs text-gray-500">↓ 8% vs last month</span>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-2xl font-bold">${metrics.totalSpent.toLocaleString()}.00</p>
                      </div>
                      <div>
              ...
              <div className="space-y-3">
                {upcomingEvents.length > 0 ? upcomingEvents.map((event) => (
                  ...
                  <div className="text-center py-8">
                    <p className="text-gray-500">No events RSVP'd yet</p>
                    <button 
                      onClick={() => navigate('/explore')}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        <p className="text-xs text-gray-500">
                          {event.location} • {event.event_attendees?.length || 0} ticket sold
                        </p>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t">
                  <div>
                    ...
                    <p className="text-base font-semibold">{rsvps.length}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Total Revenue</p>
                    <p className="text-base font-semibold">${metrics.totalSpent}</p>
                  </div>
                  <div>
